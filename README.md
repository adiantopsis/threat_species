...
* A primeira função, find_species, realiza buscas por correspondência para identificar o grau de ameaça (categoria) das espécies de um vetor em um banco de dados conhecido. Aqui disponibilizarei dois bancos (veja a pasta data), ambos em .xlsx: a Lista Nacional de Espécies da Flora Ameaçadas de Extinção (Portaria MMA nº 148 de 2022) e a lista mais recente do Centro Nacional de Conservação da Flora (CNCFlora).
